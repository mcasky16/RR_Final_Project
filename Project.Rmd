...
df_2_nona implies df with no null values
...
##   average_use_ofpresentation
## 1                          5
on the scale of 1-10 average ratimg that student feel that they will use presentation for topic is 5

on the scale to one to 10 ho much difficult assignment is 5- scale and 7-scale
...
correlation less than 0  indicate a negative correlation in our case it is -0.0569 
